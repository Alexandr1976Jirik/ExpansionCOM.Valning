class ArkDebugMonitor
{
	...
	{
		m_WidgetRoot = GetGame().GetWorkspace().CreateWidgets("$CurrentDir:missions\\ExpansionCOM.Valning\\core\\modules\\DebugMonitor\\gui\\layouts\\day_z_debug_monitor.layout");
