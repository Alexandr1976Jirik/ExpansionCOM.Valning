class CommunityOfflineClient : MissionGameplay
{
	...
	override void OfflineMissionStart()
	{
		...
		if (player)
		{
			...
			item = player.GetInventory().CreateInInventory("HockeyHelmet_Black");
			...
			item = player.GetInventory().CreateInInventory("CargoPants_Black");
			item = player.GetInventory().CreateInInventory("MilitaryBoots_Black");
			item = player.GetInventory().CreateInInventory("AliceBag_Black");
